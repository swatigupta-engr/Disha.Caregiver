...
import com.zuccessful.trueharmony.fragments.BegainAgainReport;
...
public class BeginAgainActivity extends AppCompatActivity implements AddActivityPopUpFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_begin_again);
        Log.d("BeginAgainActivity", "onCreate: started");
        ...
        getSupportActionBar().setTitle(getString(R.string.begin_again_routine));
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        Log.d("BeginAgain", "onCreate: Initialized the fragment transaction");
